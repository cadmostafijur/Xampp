...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO bus_schedules_2 (departure_location, arrival_location, departure_time, arrival_time, bus_capacity, price) VALUES ('$departure_location', '$arrival_location', '$departure_time', '$arrival_time', '$bus_capacity', '$price')";
...
<body>
    <div class="container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <input type="text" id="departure_location" name="departure_location" value="BRAC University" readonly><br>
